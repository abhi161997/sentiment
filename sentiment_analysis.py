...
def sentiment_main(infile, output, n_chunks) :
    ''' Reads the arguments
    ...
    #n_chunks = 10
    #output = "sentiment_analysis_results"
    ...
    plot_data(data, output, n_chunks)



if __name__ == "__main__":
    file = "testing.txt"
    fi = open(file, mode='r', buffering=-1, encoding=None, errors=None, newline=None, closefd=True, opener=None)
    sentiment_main(fi,"UPLOAD_FOLDER", 10)
